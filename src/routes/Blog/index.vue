				...
				<div class = "blog-main-wrap">
					<div class = "blog-main">
						...
						<Page
							...
							:maxPage = "blog.page.max"
							:pageLimit = "blog.page.limit"
	...
	export default {
		...
		methods: {
			handleClickFilter (event, item) {
				const type = types.GET_ALL.name;
				const pageId = this.$route.query.pageId || 1;
				const success = () => { this.state.filterActiveItem = item.id; };
				this.$store.dispatch(type, { success, query: { pageId }});
			},
